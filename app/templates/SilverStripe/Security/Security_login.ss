    ...
    <body <% if $darkModeIsEnabled() %>class="dark-mode-enabled"<% end_if %>>
        ...
        <main class="login-form">
            ...
            <% if not $CurrentMember %>
                <div style="padding-bottom:10px">Please login using email "admin" and password: "password"</div>
            <% end_if %>

            $Form

            <div>
                <p style="padding-top:10px">You can also try the CMS interface in a different language with<br />
